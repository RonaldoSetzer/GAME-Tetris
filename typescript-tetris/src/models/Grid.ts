...
export class Grid {
    ...
    constructor(cols = 10, rows = 20) {
        this._grid = new Array<Array<Tile>>();
        this._maxCols = cols;
        this._maxRows = rows;
    ...
    public removeRow(index: number): Array<Tile> {
        let removedRow: Array<Tile> = this.getRow(index);
    ...
    public getRow(index: number): Array<Tile> {
    ...
    private insertNewEmpytRow(index: number): void {
        let newRow: Tile[] = new Array<Tile>();
